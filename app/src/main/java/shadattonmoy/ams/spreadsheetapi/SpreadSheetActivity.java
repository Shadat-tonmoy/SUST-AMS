...
public class SpreadSheetActivity extends AppCompatActivity
    ...
    static final String[] SCOPES = { SheetsScopes.SPREADSHEETS_READONLY, DriveScopes.DRIVE_METADATA_READONLY };
     ...
     */
    private class MakeRequestTask extends AsyncTask<Void, Void, List<SpreadSheet>> {
        ...
        @Override
        protected void onPostExecute(List<SpreadSheet> output) {
            mProgress.hide();
